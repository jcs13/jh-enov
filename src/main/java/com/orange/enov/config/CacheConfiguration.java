package com.orange.enov.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.orange.enov.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.orange.enov.repository.UserRepository.USERS_BY_EMAIL_CACHE);
